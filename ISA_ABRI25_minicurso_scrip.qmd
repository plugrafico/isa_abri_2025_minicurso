...
-   This workshop is based on the unpublished manuscript *Combining clusters from network analysis with topic modelling: a late-fusion approach* by Rafael Mesquita (UFPE), Vanessa Lira (UEPB), José F. G. Neto (UEPB), Antonio Pires (UFPE)
